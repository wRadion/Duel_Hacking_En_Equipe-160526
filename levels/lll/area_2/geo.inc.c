...
const GeoLayout lll_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -1027, 827, 228),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 426, 827, 1154),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 1384, 827, -510),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 44, 1745, 30),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
