...
const LevelScript level_lll_entry[] = {
	...
	END_AREA(),
	AREA(2, lll_area_2),
		OBJECT(MODEL_BULLY_BOSS, 593, 1069, -245, 0, 0, 0, (0x02 << 24), bhvBigBullyWithMinions),
		OBJECT(MODEL_NONE, -35, 3504, -145, 0, 0, 0, 0x00000000, bhvAirborneWarp),
		OBJECT(MODEL_NONE, -1027, 827, 228, 0, 0, 0, 0x00000000, ),
		OBJECT(MODEL_NONE, 426, 827, 1154, 0, 0, 0, 0x00000000, ),
		OBJECT(MODEL_NONE, 1384, 827, -510, 0, 0, 0, 0x00000000, ),
		OBJECT(MODEL_NONE, 44, 1745, 30, 0, 0, 0, 0x00000000, ),
