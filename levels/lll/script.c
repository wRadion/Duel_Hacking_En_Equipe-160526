...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_NONE, -638, 1588, -1483, 0, 0, 0, (0xFF << 16), bhvPoleGrabbing),
		OBJECT(MODEL_NONE, -1021, 1916, 864, 0, 0, 0, (0xFF << 16), bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 885, 2438, -655, 0, 0, 0, (0xFF << 16), bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 566, 2307, -960, 0, 0, 0, (0xFF << 16), bhvPoleGrabbing),
		OBJECT(MODEL_NONE, -7544, 923, -560, 0, 0, 0, 0x00000000, ),
		OBJECT(MODEL_NONE, -10, 2876, 29, 0, 0, 0, 0x00000000, bhvWarp),
		OBJECT(MODEL_NONE, -8023, 923, -1901, 0, 0, 0, 0x00000000, ),
	...
	END_AREA(),
	AREA(2, lll_area_2),
		OBJECT(MODEL_BULLY_BOSS, 9, 1022, -22, 0, 0, 0, (0x01 << 24), bhvBigBullyWithMinions),
		OBJECT(MODEL_NONE, 1, 3041, 7, 0, 0, 0, 0x00000000, bhvAirborneWarp),
		OBJECT(MODEL_NONE, -334, 283, -317, 0, 0, 0, 0x00000000, ),
		OBJECT(MODEL_NONE, 210, 283, 426, 0, 0, 0, 0x00000000, ),
		OBJECT(MODEL_NONE, 441, 283, -206, 0, 0, 0, 0x00000000, ),
